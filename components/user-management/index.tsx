...
const UserManagement: React.FC = () => {
  ...
  const pyramidOptions: PyramidOptions = {
    legend: {
  ...
  const indexNum = (cell: any, row: any, enumObject: any, index: number): React.ReactElement => {
    return <div>{index + 1}</div>;
  };
  const addressEdit = (cell: any, row: { city?: string; state?: string }): React.ReactElement => {
    console.log(row);
    return (
      <div>
        {row?.city}, {row?.state}
  ...
  let ModeratorsData: ModeratorsDataItem[] = [
    {
      name: "Moderator A",
      email: "vijit@gmail.com",
      roll: "Roll",
    ...
    <>
      <div className="content-header">
        <div className="container-fluid">
          <div className="row">
            <h1 className="m-0 text-dark">User Roles and Permissions</h1>
          </div>
        </div>
      </div>
