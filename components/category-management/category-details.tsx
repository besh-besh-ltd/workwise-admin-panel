...
const CategoryDetails: React.FC = () => {
  const [catData, setCatData] = useState<CategoryData | string>("");
  ...
  const handleDetails = (): void => {
    getCategoriesDetails(id as string)
      .then((res : any) => {
          ...
          <div className="card col-12">
            ...
            <div className="card-body">
              <div className="d-flex">
                ...
                <div>
                  <p>
                    <strong>Title-</strong> {categoryData?.title}
                  </p>
                  <p>
                  ...
                  <p>
                    ...
                    {categoryData?.updatedAt?.split(" ")[0]}
                  </p>
                  <p>
                    <strong>Status-</strong>{" "}
                    {categoryData?.staus != 0 ? "Active" : "Inactive"}
                  </p>
                  <p>
                    <strong>Is Deleted-</strong>{" "}
                    {categoryData?.is_deleted == 1 ? "Deleted" : "Not Deleted"}
                  </p>
                </div>
              </div>
            </div>
