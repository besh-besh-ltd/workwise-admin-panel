...
interface MappingEntry {
    ...
    buyer_name?: string;
    vendor_name?: string;
    buyer_email_display?: string;
    vendor_email_display?: string;
    buyerEmail?: string;
    vendorEmail?: string;
    status: string;
    reason?: string;
...
interface MappingResults {
    ...
    mappedEntries?: MappingEntry[];
    unmappedEntries?: MappingEntry[];
}
...
const BulkBuyerVendorMapping: React.FC = () => {
    ...
    const handleUpload = async (): Promise<void> => {
        ...
        try {
            ...
            const response : APIResponse = await handleBulkBuyerVendorMapping(formData) as any;
                    ...
                    {results && (
                        <div className="card">
                            ...
                            <div className="card-body">
                                ...
                                {results.mappedEntries && results.mappedEntries.length > 0 && (
                                    <div className="mb-4">
                                ...
                                {results.unmappedEntries && results.unmappedEntries.length > 0 && (
                                    <div>
