...
const ModerateRestriction: React.FC = () => {
  return (
    <>
                      ...
                      <form>
                        ...
                        <div>
                          <div className="d-flex justify-content-around">
                            <div>
                              <label htmlFor="inputZip">User Management</label>
                              <input
                            ...
                            <div>
                              <label htmlFor="inputZip">Payment Management</label>
                              <input
                                className="form-check-input mt-5"
                                type="checkbox"
                                id="inputZip"
                            ...
                            <div>
                              <label htmlFor="inputZip">Product Management</label>
                              <input
                                className="form-check-input mt-5"
                                type="checkbox"
                                id="inputZip"
