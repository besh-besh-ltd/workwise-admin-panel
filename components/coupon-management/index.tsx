...
const CouponManagement: React.FC = () => {
    ...
    const [updateCoupon, setUpdateCoupon] = useState<CouponItem | null>(null);
    ...
    const subscriptionUserTypes: Record<string, string> = {
      2: 'Buyer',
      3: 'Vendor',
    };
    ...
    const handleCouponUpdate = (item: CouponItem): void => {
